...
func (id *identity) Verify(msg []byte, sig []byte) error {
	...
	// Compute Hash
	mspIdentityLogger.Debugf("Verify: SignatureHashFamily = %s", id.msp.cryptoConfig.SignatureHashFamily)
	...
	if mspIdentityLogger.IsEnabledFor(zapcore.DebugLevel) {
		...
		mspIdentityLogger.Debugf("Verify: id pk type = %s", reflect.TypeOf(id.pk))
		mspIdentityLogger.Debugf("Verify: id msp = %s", reflect.TypeOf(id.msp))
		mspIdentityLogger.Debugf("Verify: id.msp.bccsp = %s", reflect.TypeOf(id.msp.bccsp))
		mspIdentityLogger.Debugf("Verify: msg = %s ", hex.Dump(msg))
	}
